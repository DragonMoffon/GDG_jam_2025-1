...
class Editor:
    ...
    def push_mode(self, mode: EditorMode[Editor]):
    ...
    def pop_mode(self) -> EditorMode[Editor]:
    ...
    def execute(self, command: EditorCommand):
        ...
        command.execute() # TODO: pass editor in here?
    ...
    def redo(self):
        ...
        if self._command_offset == 0:
            return None # Cannot redo any more than this as we have reached the end of the command stack
        command = self._command_stack[-self._command_offset]
        command.execute() # TODO: pass editor in here?
        self._command_offset += 1
