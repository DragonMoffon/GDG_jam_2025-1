...
class ClippingMask:
    ...
    def __init__(
        ...
        self._program = pygl.current_context.create_program(
            (_clip_vertex_source, "vertex"), (_clip_fragment_source, "fragment")
        )
    ...
    def _create_clip_group(self):
        return ClipGroup(
            self.target_texture, self.clip_texture, self._program, self._user_group
        )
