...
class Popup(Element):
    ...
    def connect_renderer(self, batch: Batch | None):
        self._body.group = batch and PRIMARY_GROUP
        self._shadow.group = batch and SHADOW_GROUP
...
class InfoPopup(Popup):
    ...
    def connect_renderer(self, batch: Batch | None):
        ...
        self._text.group = batch and PRIMARY_GROUP
...
class SelectionPopup(Popup):
    ...
    def connect_renderer(self, batch: Batch | None):
        ...
        for action in self.actions:
            ...
            p.group = batch and PRIMARY_GROUP
            p.batch = batch
            t = self._action_text[action]
            t.group = batch and PRIMARY_GROUP
            t.batch = batch
...
class Gui:
    ...
    def remove_element(self, element: Element):
        ...
        del self._elements[element.uid]
